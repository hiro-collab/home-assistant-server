...
(() => {
  ...
  const reviewedRouteActions = [
    ...
    },
    {
      ...
      route_shortcut_class: "reviewed_light_on_command_stimulus_candidate",
      command_stimulus_class: "directional_command_submission_without_state_claim",
    ...
    },
    {
      ...
      route_shortcut_class: "reviewed_light_off_command_stimulus_candidate",
      command_stimulus_class: "directional_command_submission_without_state_claim",
      verification_mode: "command_ack_only",
      state_tracking: "ack_only",
      restore_required: false,
      proof_ceiling: "operator_shortcut_submission_summary_only",
      later_runtime_count_bound: "negative1_restore0",
      timing_estimate_class: "external_observation_required",
    },
    {
      action_id: "fan_on",
...
def _light_demo_mappings_present(config: BridgeConfig) -> bool:
    return any(
        action_id in {"light_on", "light_off"}
        and action.ha_script == f"script.demo_{action_id}"
